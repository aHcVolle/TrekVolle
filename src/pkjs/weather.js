...
function YahooImageToWeatherID(Image)
{
   switch(Image)
   {
      case 31: case 33:
         return 1;
      case 23: case 24: case 25: case 32: case 34: case 36:
         return 2;
      case 27: case 29:
         return 3;
      case 26: case 28: case 30: case 44:
         return 4;
      case 5:  case 6:  case 7:  case 8:  case 11: case 12: case 35:
         return 7;
      case 8:  case 9:  case 40:
         return 9;
      case 0:  case 1:  case 2:  case 3:  case 4:  case 17: 
      case 35: case 37: case 38: case 39: case 45: case 47:
         return 10;
...
function OpenStreetMapGetCityByLoc(dictionary,Location)
{
   ...
   xhrRequest(url, 'GET', function(responseText) 
   {
      ...
      if(typeof json.address !== "undefined")
      {
         ...
         dictionary.WEATHER_LOCATION = city;
